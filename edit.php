...
<html>
	<head>
		<title>Registration Renew</title>
	...
	<body>
		...
		<div class="container">
			...
			<div id="headerpic">
				<center><h3>Edit Contact Form</h3></center>
			</div>
			...
			<div>
				<form name="reg_form" role="form" class="bs-example bs-example-form" method="post" action="editContact.php" 
				onSubmit="return formCheck();">
					<input type="hidden" name="id" value="<?php echo $id; ?>"/>
					<div class="row">
						<div class="input-group col-md-5" id="fname">
							<label for="country">First Name</label>
							<input type="text" name="fname" value="<?php echo $res['fname']; ?>" class="form-control" placeholder="First Name" required>
						</div>
					</div>
					...
					<div class="row">
						<div class="input-group col-md-5" id="lname">
							...
							<input type="text" name="lname" value="<?php echo $res['lname']; ?>" class="form-control" placeholder="Last Name" required>
						</div>
					</div>
					...
					<div class="row">
						<div id="country" class="col-sm-5">
							...
							<select class="form-control" name="country"><optgroup>
						            <option selected="selected" value=""><?php echo $res['country']; ?></option>
					...
					<div class="row">
						<div class="input-group col-md-5" id="phonenumber">
							...
							<input type="tel" name="phonenumber" value="<?php echo $res['phonenumber']; ?>" class="form-control" placeholder="Enter Phone Number">
						</div>
					</div>
					...
					<div class="row">
						<div class="input-group col-md-5" id="addressline">
							...
							<input type="text" class="form-control" value="<?php echo $res['addressline']; ?>" name="addressline" placeholder="Enter Address">
						</div>
					</div>
					...
					<div>
						<div class="form-group" id="text">
							...
							<textarea class="form-control" value="<?php echo $res['description']; ?>" name="description" rows="3" placeholder="Enter Brief Description About yourself"></textarea>
						</div>
					</div>

					<div id="button2">
						<input type="submit" name="save" class="btn btn-primary" value="Save Contact">
					</div>
				</form>
			</div>
<?php
 ...
 ?>
			...
			<div id="buttons1">
				<a href="viewcontacts.php"><button type="button" class="btn btn-primary">
				View Contacts </button></a>
			</div>
			<footer>
